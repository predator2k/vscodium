...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  ...
  setpath "product" "nameShort" "RA Studio"
  setpath "product" "nameLong" "RA Studio"
  setpath "product" "applicationName" "ra-studio"
  setpath "product" "dataFolderName" ".ra-studio"
  setpath "product" "linuxIconName" "ra-studio"
  setpath "product" "quality" "stable"
  setpath "product" "urlProtocol" "ra-studio"
  setpath "product" "serverApplicationName" "ra-studio-server"
  setpath "product" "serverDataFolderName" ".ra-studio-server"
  setpath "product" "darwinBundleIdentifier" "com.ra-studio.app"
  setpath "product" "win32AppUserModelId" "RAStudio.RAStudio"
  setpath "product" "win32DirName" "RA Studio"
  setpath "product" "win32MutexName" "ra-studio"
  setpath "product" "win32NameVersion" "RA Studio"
  setpath "product" "win32RegValueName" "RA Studio"
  setpath "product" "win32ShellNameShort" "RA Studio"
